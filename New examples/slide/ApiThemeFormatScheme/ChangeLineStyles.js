...
oGs2 = Api.CreateGradientStop(Api.CreateRGBColor(255, 164, 101), 100000);
oNewFill3 = Api.CreateRadialGradientFill([oGs1, oGs2]);
oNewStroke3 = Api.CreateStroke(0, oNewFill3);
oFormatScheme.ChangeLineStyles([oNewStroke1, oNewStroke2, oNewStroke3]);
